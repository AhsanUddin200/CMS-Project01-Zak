...
function dashboard() {
  ...
  return (
    <>
      <div>
        <h1 className="flex justify-center px-4 py-2 font-bold text-balance text-xl">
          Welcome to Dashboard
        </h1>
        <div className="flex flex-row items-center px-12 py-24 gap-4 w-full">
          <div className="w-2/4 px-24 items-center">
            <img
              src="https://www.accoxi.com/media/3163/weighing-scale.png?anchor=center&mode=crop&width=700&height=477&rnd=132917319600000000"
              width={"500px"}
            />
          </div>
          <div className="w-1/3">
            <h2 className="font-bold">
              WEIGHING TRUCK DATA WITH WEIGHT EXPERT
            </h2>
            <p>
              Weighing scale data in Accoxi is a form where users can export
              product details to a weighing machine format. Weighing machines
              are used to measure the weight of products, so products in Accoxi
              should be integrated with the weighing machine set-up. For that,
              using the weighing machine data form users can export the product
              details in the prescribed format compatible with the weighing
              machine.
            </p>
          </div>
        </div>
        ...
        <Link className="flex justify-end p-2 hover:underline" to="/">
          Go Back to Home
        </Link>
      </div>
    </>
